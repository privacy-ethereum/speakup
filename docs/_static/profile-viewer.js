(function () {
  ...
  const DEFAULT_COSTS = {
    ...
    I32Load: { pub: 95, steps: 1 },
    I32Store: { pub: 95, steps: 1 },
    I32Load8S: { pub: 95, steps: 1 },
    I32Load8U: { pub: 95, steps: 1 },
    I32Load16S: { pub: 95, steps: 1 },
    I32Load16U: { pub: 95, steps: 1 },
    I32Store8: { pub: 95, steps: 1 },
    I32Store16: { pub: 95, steps: 1 },
    I64Load: { pub: 190, steps: 2 },
    I64Store: { pub: 190, steps: 2 },
    I64Load8S: { pub: 95, steps: 2 },
    I64Load8U: { pub: 95, steps: 2 },
    I64Load16S: { pub: 95, steps: 2 },
    I64Load16U: { pub: 95, steps: 2 },
    I64Load32S: { pub: 95, steps: 2 },
    I64Load32U: { pub: 95, steps: 2 },
    I64Store8: { pub: 95, steps: 2 },
    I64Store16: { pub: 95, steps: 2 },
    I64Store32: { pub: 95, steps: 2 },
    F32Load: { pub: 95, steps: 1 },
    F32Store: { pub: 95, steps: 1 },
    F64Load: { pub: 190, steps: 2 },
    F64Store: { pub: 190, steps: 2 },
    Copy: { pub: 0, steps: 1 },
